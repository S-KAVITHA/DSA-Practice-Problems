...
public class LeapYear {
	...
	/*
	 * This method checks whether a year is a leap or not by using Java Date and
	 * Time API. Calendar class has a utility method to return maximum number of
	...
	/*
	 * This method uses standard logic to check leap year in Java. A year is a leap
	 * year if its multiple of 400 or multiple of 4 but not 100
	 */
